# Benchmark Matrix — Salt Storage Near Water (Draft v2)
...
|---|---|---|---|---|---|---|---|---|---|---|
| **New Haven, CT (baseline case)** | ~135k residents; coastal port city on New Haven Harbor / Long Island Sound | CT permit-driven model: MS4 GP + Industrial Stormwater GP + water-quality enforcement + release-based cleanup exposure | Vessel-to-port logistics (project baseline assumption), then truck transfer to municipal use points | Waterfront/port bulk handling is the baseline context under review | Municipal day-to-day storage pattern is being validated (current split still under review) | Current condition under review; target state is covered storage with written SOP + inspections | Impervious pad + runoff minimization/containment + housekeeping controls | Near-term compliance hardening, then potential shift toward lower-waterfront exposure model | **High relevance** (home case) | Repo: `SOURCE_OF_TRUTH.md`; deck slides 2–3; CT DEEP stormwater page; New Haven population reference |
